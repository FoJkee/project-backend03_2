...
authRouter.post('/registration', rateLimitDeviceMiddleware, UserLoginValidator, UserPasswordValidator,
...
authRouter.post('/login', rateLimitDeviceMiddleware, LoginOrEmailValidator, UserPasswordValidator,
...
authRouter.post('/registration-confirmation', rateLimitDeviceMiddleware, CodeValidator, errorsMiddleware,
    authController.registrationConformation.bind(authController))

authRouter.post('/registration-email-resending', rateLimitDeviceMiddleware, UserEmailValidator,
    customValidator.customEmailValidator.bind(customValidator), errorsMiddleware,
    authController.registrationEmailResending.bind(authController))

authRouter.post('/password-recovery', rateLimitDeviceMiddleware, UserEmailValidator, errorsMiddleware,
    authController.passwordRecovery.bind(authController))

authRouter.post('/new-password', rateLimitDeviceMiddleware, NewPasswordValidator, RecoveryCodeValidator,
